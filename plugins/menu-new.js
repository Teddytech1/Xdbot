...
cmd({
    ...
    try {
        ...
        const botName = userConfig?.BOT_NAME || config.BOT_NAME || "TEDDY-XMD";
        const ownerName = userConfig?.OWNER_NAME || config.OWNER_NAME || "TEDDY-XMD";
        const prefix = userConfig?.PREFIX || config.PREFIX || ".";
        const mode = userConfig?.MODE || config.MODE || "public";
        const botImage = userConfig?.BOT_IMAGE || config.BOT_IMAGE || "https://files.catbox.moe/9yy6iy.jpg";
...
> ${userConfig?.DESCRIPTION || config.DESCRIPTION || '© Powered by Teddy Tech Hub'}`;
